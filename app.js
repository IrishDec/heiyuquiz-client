...
if (!window.SERVER_URL) {
  window.SERVER_URL = "https://api.heiyuquiz.com";
}
...
(function regionDropdown(){
  ...
  if (!regionSel || !countrySel) return;

  let list = [];
  try {
    list = JSON.parse(localStorage.getItem('hq-countries-v1') || '[]');
  } catch {}
